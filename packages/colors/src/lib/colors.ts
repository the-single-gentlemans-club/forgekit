...
export function isValidRgb(rOrRgb: number | Partial<RgbColor>, g?: number, b?: number): boolean {
...
export function rgbToHsl(rOrRgb: number | RgbColor, g?: number, b?: number): HslColor {
  let r: number
