    ...
    tools: [
      {
        ...
        description:
          'List all React components in the project. Can filter by library and whether they have stories.',
        inputSchema: {
          type: 'object',
          properties: {
            library: {
              type: 'string',
              description:
                'Filter by library name (e.g., "ui", "shared"). Use "all" for all libraries.',
            },
            hasStory: {
              type: 'boolean',
      ...
      },
      {
        ...
        description:
          'Analyze a React component to extract props, dependencies, and suggestions for story generation.',
        inputSchema: {
          type: 'object',
          properties: {
            componentPath: {
      ...
      },
      {
        name: 'generate_story',
        description:
          'Generate a Storybook story file for a component. Analyzes the component and creates appropriate stories.',
        inputSchema: {
          type: 'object',
          properties: {
            componentPath: {
      ...
      },
      {
        name: 'sync_all',
        description:
          'Sync all components - create missing stories/tests/docs and update changed ones. Runs automatically on startup but can be triggered manually.',
        inputSchema: {
          type: 'object',
          properties: {
            library: {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            figmaNodeUrl: {
              type: 'string',
              description:
                'Figma component URL (e.g. https://figma.com/design/xxx/yyy?node-id=zzz). If omitted, a placeholder is used.',
            },
            overwrite: {
              type: 'boolean',
      ...
      },
      {
        name: 'check_health',
        description:
          'Check Storybook installation health — missing packages, outdated configs, version mismatches',
        inputSchema: {
          type: 'object',
          properties: {},
        },
